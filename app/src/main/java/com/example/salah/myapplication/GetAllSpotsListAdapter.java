 ...
 */
public class GetAllSpotsListAdapter extends BaseAdapter {

    private JSONArray dataArray;
    private Activity activity;

  //  private static final String baseUrlForImage = ApiConnector.ip + "img/"; //Url for Img folder

    private static LayoutInflater inflater = null;

    public GetAllSpotsListAdapter(JSONArray jsonArray, Activity a)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            convertView = inflater.inflate(R.layout.get_all_titles_list_cell, null);
            cell = new ListCell();
