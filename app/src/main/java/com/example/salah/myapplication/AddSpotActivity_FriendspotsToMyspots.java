 ...
 */
public class AddSpotActivity_FriendspotsToMyspots extends ActionBarActivity implements View.OnClickListener {
            ...
            case R.id.store_button:
            {
                ...
                new AsyncTask<ApiConnector,Long, Boolean >() {
                    ...
                    protected void onPreExecute() {
                        super.onPreExecute();
                        pDialog = new ProgressDialog(AddSpotActivity_FriendspotsToMyspots.this);
                ...
                Intent intent = new Intent();
                intent.setClass(AddSpotActivity_FriendspotsToMyspots.this, MainActivity.class);
