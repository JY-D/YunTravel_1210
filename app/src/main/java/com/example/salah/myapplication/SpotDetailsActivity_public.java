 ...
 */
public class SpotDetailsActivity_public extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new AsyncTask<ApiConnector_allspots,Long, Boolean >() {
                    ...
                    protected void onPreExecute() {
                        super.onPreExecute();
                        pDialog = new ProgressDialog(SpotDetailsActivity_public.this);
        ...
        mapButton.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(SpotDetailsActivity_public.this, SpotDetailsActivity_map.class);
                Bundle bundle = new Bundle();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) { // 攔截返回鍵
            Intent intent = new Intent();
            intent.setClass(SpotDetailsActivity_public.this, MainActivity.class);
            startActivity(intent);
            finish();
        }
        return true;
